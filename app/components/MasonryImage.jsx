...
export default function TitlebarBelowMasonryImageList() {
  return (
    <Box sx={{ minWidth:1200, height: '70vh', overflow: 'hidden', position: 'relative'}}>
      <ImageList sx={{position:'absolute',top:0, left:0, bottom:'-31px', right:'-15px', overflow:'scroll'}} variant="masonry" cols={5} gap={8}>
        {itemData.map((item) => {
...
const itemData = [
    ...
    {key:10,img:"/img/IP Mall.png",title:'IP Mall', subtitle:'Banquet in loving memory of Teresa Teng'},
